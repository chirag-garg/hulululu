...
public class LoginTest {
	...
	public void user_open_the_webbrowser() throws InterruptedException {
	...
	public void show_the_error_message_as(String arg1){
	...
	@Then("^navigate to the next page with title as \"([^\"]*)\"$")
	public void navigate_to_the_next_page_with_title_as(String arg1) throws InterruptedException {
